terraform {
  ...
  backend "azurerm" {
    ...
    key                  = "landing-zones/production/orders/terraform.tfstate"
  }
}
...
variable "subscription_id" {
  type        = string
  description = "The subscription ID for the orders team landing zone."
}
...
output "vnet_id" {
  description = "The resource ID of the orders production spoke virtual network."
  value       = module.orders_landing_zone.vnet_id
}

output "application_subnet_id" {
  description = "The resource ID of the orders production application subnet."
